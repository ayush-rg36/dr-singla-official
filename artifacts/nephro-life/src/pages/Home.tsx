  ...
  return (
    <div className="min-h-screen bg-white font-sans text-foreground">
      ...
      >
        ...
        {/* Button */}
        <span className="relative flex items-center justify-center w-14 h-14 rounded-full bg-[#25D366] shadow-[0_4px_24px_rgba(37,211,102,0.45)] transition-transform duration-200 ease-out group-hover:scale-110 group-hover:shadow-[0_6px_32px_rgba(37,211,102,0.6)]">
